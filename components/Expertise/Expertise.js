...
const expertiseList = [
  ["IOT", "Artificial Intelligence", "Blockchain"],
  ["Web Development", "UI Designs", "Mobile Apps"],
  ["Big Data", "Cloud Storage", "Cybersecurity"],
  ["Data Analytics", "Deep Learning", "Drones"],
  ["Facial Recognition", "Fintech", "Gamification"],
  ["Genetic Engineering", "Haptic Technology", "Holographic Displays"],
  ["Hyperautomation", "Intelligent Assistants", "BaaS"],
  ["Chatbots", "DApps", "Low-Code/No-Code Development"],
  ["Headless CMS", "Serverless Architecture", "SPAs"],
];
